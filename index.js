...
let remainingSecond = (currentSeconds % 60)
let formattedSecond = remainingSecond < 10 ? `0${remainingSecond}` : remainingSecond
let formattedMinutes = minutes < 10 ? `0${minutes}` : minutes
currentTime.textContent = `${formattedMinutes}:${formattedSecond}`
}
